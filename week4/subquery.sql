...
/* Retrieve product name where price is between 20 and 500 using a subquery in FROM */
SELECT 
    X.pname
FROM 
    (SELECT * FROM Product WHERE price > 20) AS X
WHERE 
    X.price < 500;
...
FROM 
    Product AS X
WHERE 
    X.price > 20 AND X.price < 500;


/* ========================================= */
/* Example 4: Subquery with WHERE EXISTS     */
/* ========================================= */
...
/* Unnested version using implicit INNER JOIN */
SELECT DISTINCT 
    C.cname
FROM 
    Company C, Product P
WHERE 
    C.cid = P.cid AND P.price < 200;


/* ========================================= */
/* Example 5: WHERE ALL vs WHERE NOT EXISTS  */
/* ========================================= */

/* Find companies such that all their products have price < 200 using ALL */
SELECT DISTINCT 
    C.cname 
FROM 
    Company C
...
/* Equivalent query using NOT EXISTS */
SELECT DISTINCT 
    C.cname 
FROM 
    Company C
